...
if [ $# -lt 2 ]; then
  echo 1>&2 "Usage: create_landuse_table.sh N51045 CFBASE30Y20180615 [version=p6]"
  exit 2
fi 
...
template="cbp_${version}_cfbase30y20180615_n51161"
filename="/media/NAS/omdata/${version}/out/land/$scenario/eos/${landseg}_0111-0211-0411.csv"
