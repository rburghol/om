...
for runid in $runids; do
  ...
  case $runid in 
    11)
      ...
      cmd="run_shakeTree.php 1 $elid $runid $startdate $enddate $cachedate $force 37 -1 $run_mode normal flow_mode=$flow_mode"
      ;;
    ...
    17)
      run_mode=12
      flow_mode=6
      cmd="run_shakeTree.php 1 $elid $runid $ccstart $ccend $cachedate $force 37 -1 $run_mode normal flow_mode=$flow_mode" 
      ;;
