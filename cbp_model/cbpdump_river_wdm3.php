...
if (count($argv) < 3) {
   print("Usage: php cbpdump_river_wdm2.php reachid(4-digit) dsn [scenarioname] [forceoverwritre=0] \n");
   die;
}
...
error_log("WDM Path set to $wdmpath \n");
$filename = importWDMData3($cbp_listobject, $dsn_names, $wdmpath, $dsns, $scid, 'river', $id2, '', $starttime, $endtime);
