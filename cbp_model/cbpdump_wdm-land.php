...
foreach ($lunames as $luname) {
   ...
   print("Land Segment WDM's found in $dirpath : found " . count($files) . " wdm files <br>\n");
   print("Handling $luname <br>\n");
   $desiredfiles = array();
   print("Searching for filename pattern %$onelseg% <br>\n");
   ...
   print("Land Segment WDM's selected for import : <br>\n" . print_r($desiredfiles,1) . " <br>\n");
   foreach ($desiredfiles as $filename) {
      ...
      importWDMData($cbp_listobject, $dsn_names, $wdmpath, $dsns, $scid, $landseg, $luname, $starttime, $endtime);
