...
class waterSupplyModelNode extends modelContainer {
   ...
   function showShapeOnMap() {
      ...
      if (is_object($this->listobject)) {
         $this->listobject->querystring = "select extent(geomFromText('$this->the_geom')) as ext ";
...
class wsp_PopBasedProjection_VAWC extends wsp_PopBasedProjection {
   ...
   var $basedata = 'http://deq2.bse.vt.edu/data/proj3/components/vawc/vawc_1.2012.csv';
   var $poptable = array();
   var $fips = '';
   var $value_dbcolumntype = 'float8';
   var $yearvar = '';
...
class wsp_VWUDSData extends XMLDataConnection {
   ...
   var $current_mgd = 0.0;
   var $feed_address = 'http://deq2.bse.vt.edu/om/remote/xml_getdata_wateruse.php';
   var $data_inventory_address = 'http://deq2.bse.vt.edu/om/remote/xml_getdata_wateruse.php';
   ...
   function wake() {
      $this->feed_address = 'http://deq2.bse.vt.edu/om/remote/xml_getdata_wateruse.php';
      $this->data_inventory_address = 'http://deq2.bse.vt.edu/om/remote/xml_getdata_wateruse.php';
      parent::wake();
