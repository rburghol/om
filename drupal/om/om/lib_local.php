...
function getCBPLandSegIntersection($dbobj, $wktgeom, $fipsab = -1) {
   ...
   $dbobj->querystring .= "    asText(memgeomunion(intersection(setsrid(geomfromtext('$wktgeom'),4326),the_geom))) as wktgeom ";
   $dbobj->querystring .= " from gis_cbp_landsegs_dd ";
   $dbobj->querystring .= " where setsrid(geomfromtext('$wktgeom'),4326) && the_geom ";
   $dbobj->querystring .= "    and area2d(intersection(setsrid(geomfromtext('$wktgeom'),4326),the_geom)) > 0 ";
