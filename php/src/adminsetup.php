   ...
   $adminsetuparray = array(
      ...
      "waterSupplyModelNode"=>array(
          ...
          "column info"=>array(
              ...
              "log2db"=>array("type"=>3,"params"=>"0|Memory,1|Database,2|File:lid:lname::0:","label"=>"Runtime Logging Option ","visible"=>1, "readonly"=>0, "width"=>6),
              "run_mode"=>array("type"=>1,"params"=>"","label"=>"Run Mode (for custom use by model components) ","visible"=>1, "readonly"=>0, "width"=>6),
              "flow_mode"=>array("type"=>3,"params"=>"0|Best Available,1|USGS Baseline,2|USGS Synthetic,3|VAHydro HSPF,4|Qcbp6,5|Qcbp6 CC1,6|Qcbp6 CC2,7|Qcbp6 CC3:fmid:fmname::0","label"=>"Flow Mode (0 - best available, 1 - USGS baseline, 2 - USGS Synth, 3 - VA HSPF, 4+ - Custom) ","visible"=>1, "readonly"=>0, "width"=>6),
