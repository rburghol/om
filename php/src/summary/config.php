...
include_once("$libdir/lib_vwuds.php");
include_once("$libdir/lib_vpdes.php");
# local modeling object
include_once("$libdir/lib_hydro.php");
...
#$dbconn = pg_connect("host=localhost port=5432 dbname=wsp user=wsp_ro password=q_only");
$wsp_dbconn = pg_connect("host=$vwuds_dbip port=5432 dbname=$vwuds_dbname user=$vwuds_dbuser password=$vwuds_dbpass");
