...
function setNLCDLanduse($elid, $lu_matrix_name = 'landuse_nlcd', $minyear = 1980, $maxyear = 2050) {
   global $usgsdb;
...
function getNestedContainersCriteria ($listobject, $elementid, $types = array(), $custom1 = array(), $custom2 = array() ) {
...
function getTree($listobject, $elementid) {
   // gets all the branches and leaves in a tree
   $containers = getNestedContainers($listobject, $elementid);
   $keepers = $containers;
