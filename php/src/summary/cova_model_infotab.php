...
error_log("Found $t withdrawal objects");
...
error_log("Generating Landuse Tab Output");
$listobject->show = 0;
...
// show withdrawals
error_log("Generating Withdrawal File and Tabular Output");
$fname = 'tmp_wd' . $userid . '.' . rand(1000,9999) . '.txt';
...
error_log("Generating Point Source File and Tabular Output");
...
error_log("Getting VWUDS Records Cotnained by basin");
...
error_log("Graphing VWUDS Records Cotnained by basin");
...
// point sources
error_log("Getting VPDES Records Cotnained by basin");
...
error_log("Graphing VPDES Records Cotnained by basin");
$graphurl = showGenericMultiPlot($goutdir, $goutpath, $multibar, $debug);
