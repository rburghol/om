      ...
      'object_specs'=>array(
         ...
         'addons'=>array(
            ...
            'CBPLandDataConnection'=>array(
               # this will be difficult to autopopulate, since a single river segment may have multiple
               # land segments associated with it.  We could take the approach of modifying the base object
               # to allow for multiple land segments, but we would need to be able to have a way of making
               # separate land-use grids for each relevant land segment.
               # for now, we can just put one of these in, and deal with the fancy stuff manually, or perhaps 
               # include the creation of these objects in the routine createBranch()
               'objecttype'=>'CBPLandDataConnection',
               'template_id'=>33749,
               'constants'=>array(
                  'scid'=>2,
                  'id1'=>'land',
