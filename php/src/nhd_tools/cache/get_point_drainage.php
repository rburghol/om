...
if (count($points) > 0) {
   ...
   print("Creating shapefile: pgsql2shp -f $filename -u $dbuser -P $dbpass va_hydro tmp_nhd_fulldrainage");
   shell_exec("pgsql2shp -f $filename -u $dbuser -P $dbpass va_hydro tmp_nhd_fulldrainage");
