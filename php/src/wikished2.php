...
<body bgcolor=ffffff onload='init(); intscript = "xajax_showStatus(xajax.getFormValues(\"elementtree\"))"; setInterval(intscript,30000); '>
...
//$browser .= showHierarchicalMenu($listobject, $projectid, $scenarioid, $userid, $usergroupids, $debug);
$menuHTML = '';
...
###              Status Bar             ###
###########################################
$status_bar = "<div style=\"display: block; border: 1px solid rgb(0 , 0, 0); background: #cdc9c9;\" ><b>Status Bar <a class=\"mHier\"id=\"statustoggle\" ";
$status_bar .= "onclick=\"toggleMenu('status_bar')\" title=\"Toggle Status Bar Visibility\"><i>Show/Hide </i></a><br>";
$status_bar .= "\n<div id='status_bar' style=\"border: 1px solid rgb(0 , 0, 0); border-style: dotted; overflow: auto; height: 100px;  width: 240px; display: block;  background: #eee9e9;\"></div></div>\n";
...
###           Model Status              ###
###########################################
$model_status = "<font face='arial'><b>Active Model Status</b></font>";
$model_status .= "\n<div id='model_status' bgcolor='lightgrey' style=\"border: 1px solid rgb(0 , 0, 0); border-style: dotted; overflow: auto; \"></div>\n";
