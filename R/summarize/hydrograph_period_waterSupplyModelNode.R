...
elid = 213151  # cootes: , mount j: 229937, strasburg: 230667
...
plot(
  ...
  ylab="Flow/WD/PS (cfs)",
  xlab=paste("Model vs USGS",startdate,"to",enddate),
  main="6-Hour Model Timestep Average to Daily",
  legend=c('Model', 'USGS')
)
lines(gage_data$flow, col='blue')
...
plot(
  ...
  ylab="Flow/WD/PS (cfs)",
  xlab=paste("Model vs USGS",startdate,"to",enddate),
  main="3-Hour Model Timestep Average to Daily",
  legend=c('Model', 'USGS')
)
lines(gage_data$flow, col='blue')
